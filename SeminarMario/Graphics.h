...
public:
	...
	LivesGraphics(Frame const& singleLife) :_singleLife(singleLife), _livesCount(4)
	{
		cv::resize(_singleLife.image, _singleLife.image, cv::Size(_singleLife.image.size[0] / 9, _singleLife.image.size[1] / 11), 0, 0);
		cv::resize(_singleLife.mask, _singleLife.mask, cv::Size(_singleLife.mask.size[0] / 9, _singleLife.mask.size[1] / 11), 0, 0);
	}
